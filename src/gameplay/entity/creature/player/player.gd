...
func _process_using_basic_attack() -> void:
	await JoystickManager.wait(current_kit.basic_attack_duration)
...
func _process_using_skill_one() -> void:
	await JoystickManager.wait(current_kit.skill_one_duration)
...
func _process_using_skill_two() -> void:
	await JoystickManager.wait(current_kit.skill_two_duration)
